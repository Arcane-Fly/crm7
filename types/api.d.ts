...
declare module '@/lib/hooks/use-bank-integration' {
  export interface BankIntegrationHook {
    ...
    isLoading: boolean
    error: Error | null
    createBankAccount: (account: Omit<BankAccount, 'id' | 'created_at' | 'updated_at'>) => Promise<BankAccount>
    createPayment: (payment: Omit<PaymentRequest, 'id' | 'created_at' | 'updated_at'>) => Promise<PaymentRequest>
