...
export function useLMS() {
  ...
  const {
    mutate: createEnrollmentMutation,
    isPending: isCreatingEnrollment,
  ...
  const {
    mutate: deleteEnrollmentMutation,
    isPending: isDeletingEnrollment,
  } = useSupabaseMutation<'enrollments'>({
    table: 'enrollments',
    onSuccess: () => {
      toast({
  ...
  const {
    mutate: updateAssessmentMutation,
  ...
  const {
    mutate: deleteAssessmentMutation,
    isPending: isDeletingAssessment,
  } = useSupabaseMutation<'assessments'>({
    table: 'assessments',
    onSuccess: () => {
      toast({
  ...
  const {
    ...
    isPending: isCreatingUnit,
  } = useSupabaseMutation<'units'>({
    table: 'units',
    onSuccess: () => {
      toast({
        title: 'Unit created',
  ...
  const createEnrollment = async (enrollmentData: Omit<Enrollment, 'id' | 'created_at' | 'updated_at'>) => {
    return createEnrollmentMutation({ data: enrollmentData })
  }

  const updateEnrollment = async (id: string, enrollmentData: Partial<Omit<Enrollment, 'id' | 'created_at' | 'updated_at'>>) => {
  ...
  const updateAssessment = async (id: string, assessmentData: Partial<Omit<Assessment, 'id' | 'created_at' | 'updated_at'>>) => {
  ...
  const updateUnit = async (id: string, unitData: Partial<Omit<Unit, 'id' | 'created_at' | 'updated_at'>>) => {
