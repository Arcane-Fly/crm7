...
import { CalendarIcon, MapPinIcon, PhoneIcon, EnvelopeIcon, LinkIcon } from 'lucide-react';
...
export function CandidateProfile({ candidate }: CandidateProfileProps): ReactElement {
  return (
