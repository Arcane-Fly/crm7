...
const sections = {
  ...
  hr: [
    ...
    { title: "Performance Reviews", href: "/hr/performance" },
  ...
  compliance: [
    { title: "Compliance Dashboard", href: "/compliance/dashboard" },
    { title: "Audit Management", href: "/compliance/audits" },
    { title: "Document Control", href: "/compliance/documents" },
    { title: "Quality Metrics", href: "/compliance/metrics" },
    { title: "Standards & Regulations", href: "/compliance/standards" },
    { title: "Compliance Training", href: "/compliance/training" },
    { title: "Corrective Actions", href: "/compliance/actions" },
...
export function SectionSidebar({ className, section = "dashboard" }: SectionSidebarProps) {
  ...
  const items = sections[section] || sections.dashboard
