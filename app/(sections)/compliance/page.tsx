      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="p-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 rounded-lg border p-3 bg-red-50">
              <div className="h-2 w-2 rounded-full bg-red-500" />
              <div>
                <p className="font-medium text-red-800">Safety Certification Expiring</p>
                <p className="text-sm text-red-600">5 certifications expire in 7 days</p>
              </div>
            </div>
            <div className="flex items-center gap-2 rounded-lg border p-3 bg-yellow-50">
              <div className="h-2 w-2 rounded-full bg-yellow-500" />
              <div>
                <p className="font-medium text-yellow-800">Training Compliance</p>
                <p className="text-sm text-yellow-600">15 employees need updated training</p>
              </div>
            </div>
            <div className="flex items-center gap-2 rounded-lg border p-3 bg-blue-50">
              <div className="h-2 w-2 rounded-full bg-blue-500" />
              <div>
                <p className="font-medium text-blue-800">Policy Update Required</p>
                <p className="text-sm text-blue-600">New regulations effective Feb 1</p>
              </div>
            </div>
          </div>
        </Card>
